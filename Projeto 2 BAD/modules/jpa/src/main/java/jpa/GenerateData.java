...
public class GenerateData {
    public static void main(String[] args) {
        ...
        Passenger[] passengers = { new Passenger("1@jospy.com", "123", "Admin1", "933333331", 100.0),
                new Passenger("2@jospy.com", "123", "Admin2", "933333332", 100.0),
                new Passenger("3@jospy.com", "123", "Admin3", "933333333", 0.0) };

        Manager[] managers = { new Manager("4@jospy.com", "123", "NotAdmin1", "933333333"),
                new Manager("5@jospy.com", "123", "NotAdmin2", "933333334"),
                new Manager("6@jospy.com", "123", "NotAdmin3", "933333335") };
